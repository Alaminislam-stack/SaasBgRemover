  ...
  return (
    <div className="h-[100vh] flex flex-col  justify-between items-center lg:py-30 py-10 lg:px-[170px] px-10">
      ...
      <div className="flex justify-end items-center px-5 py-5 gap-4 text-sm">
        <button className="px-5 py-3 rounded-4xl bg-transparent border cursor-pointer hover:scale-105 transition-all duration-500">Try another image</button>
        <button className="px-5 py-3 rounded-4xl bg-transparent border cursor-pointer bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 hover:scale-105 transition-all duration-500">Dowmloed image</button>
       </div> 
      </div>
